...
const firebaseConfig = {
  ...
  onAuthStateChanged(auth, (user) => {
    if (user) 
    {
        ...
        get(child(dbRef, 'WebUsers/Login/' + user.uid+'/Other_Documents')).then((snapshot) => {
            if (snapshot.exists())
            {
            ...
            if (snapshot.exists())
            {
                ...
                picfileInput.addEventListener('change',function(){
                    ...
                    const metaData={
                      ...
                      const storageRef=sRef(storage,"Documents/"+mail+"/photo/"+fileName);
                      ...
                      ()=>{
                       ...
                       documentform.addEventListener('submit', (e) =>{ 
                          ...
                          update(ref(database, 'WebUsers/Login/' + user.uid+'/Other_Documents'), {
                    ...
                    aadharfileInput.addEventListener('change',function(){
                        ...
                        const metaData={
                          ...
                          const storage=getStorage();
                          const storageRef=sRef(storage,"Documents/"+mail+"/Aadhar/"+fileName);
                          const UploadTask=uploadBytesResumable(storageRef,file,metaData);
                        ...
                        panfileInput.addEventListener('change',function(){
                            ...
                            const metaData={
                              ...
                              const storage=getStorage();
                              const storageRef=sRef(storage,"Documents/"+mail+"/Pancard/"+fileName);
                              const UploadTask=uploadBytesResumable(storageRef,file,metaData);
                            ...
                            gstfileInput.addEventListener('change',function(){
                                ...
                                const metaData={
                                  ...
                                  const storage=getStorage();
                                  const storageRef=sRef(storage,"Documents/"+mail+"/GST/"+fileName);
                                  const UploadTask=uploadBytesResumable(storageRef,file,metaData);
                                ...
                                bankingfileInput.addEventListener('change',function(){
                                    ...
                                    const metaData={
                                      ...
                                      const storage=getStorage();
                                      const storageRef=sRef(storage,"Documents/"+mail+"/Banking/"+fileName);
                                      const UploadTask=uploadBytesResumable(storageRef,file,metaData);
                                    ...
                                    itrfileInput.addEventListener('change',function(){
                                        ...
                                        const metaData={
                                          ...
                                          const storage=getStorage();
                                          const storageRef=sRef(storage,"Documents/"+mail+"/ITR/"+fileName);
                                          const UploadTask=uploadBytesResumable(storageRef,file,metaData);
                                        ...
                                        addressfileInput.addEventListener('change',function(){
                                            ...
                                            const metaData={
                                              ...
                                              const storage=getStorage();
                                              const storageRef=sRef(storage,"Documents/"+mail+"/Address/"+fileName);
                                              const UploadTask=uploadBytesResumable(storageRef,file,metaData);
